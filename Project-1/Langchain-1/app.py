...
SQL agent can be vulnerable to prompt injection. Use DB role with limited permission.
'''
...
if "messages" not in st.session_state or st.sidebar.button("Clear message histroy"):
